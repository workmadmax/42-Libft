...
/*   Updated: 2022/05/10 13:50:06 by mdouglas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @return This function returns non-zero value if 'c' is an alphabetic, else it returns 0.
*/
int			ft_isalpha(int c);

/**
 * @brief Checks if the passed character is a decimal digit character. numbers (0 to 9).
 * @param c This the character to be checked.
 * @return This function returns non-zero value if 'c' is a digit, else it returns 0.
*/
 ...
 * @param c This is the character to be checked.
 * @return This function returns non-zero value if 'c' is a digit or a letter, else it returns 0.
*/
 ...
 * to the first 'n' characteres of the string pointed to, by the argument 'str'.
 * @param str This is a pointer to the block of memory fill.
 * @param c This the value to be set. The value is passed as an int,
...
/**
 * @brief Fills the first 'n' bytes of the project pointed to by dest with zero (NUL) bytes.
 ...
 * @param dest This is pointer to the destination array where the content is to be copied,
...
/**
 * @brief Copies 'n' characters from 'str2'  to 'str1', but for overlapping memory blocks,
 * 'memmove()' is a safer approach than 'memcpy()'.
 * @param str1 This is a pointer to the destination array where the content is to be copied,
 * type-casted to a pointer of type void*.
 * @param str2 This is a pointer to the sourcer of data to be copied,
 * type-casted to a pointer of type void*.
...
/**
 * @brief Copies up to size - 1 characters from the NUL-terminated string src to dest,
...
/**
 * @brief Append the NUL-terminated string 'src' to the end of 'dest'.
 * It will append at most 'size'-'ft_strlen(dest)' - 1 bytes, NUL-terminating the result.
 * @param dest Pointer to the destination area of memory.
 * @param src Pointer to the source area of memory.
 ...
 * The value is returnd as an 'int' value that can be implicitly casted to 'char'.
*/
 ...
 * @return This returns a pointer to the first occurrence of the character c in the string str,
 ...
 * It is passed as its int promotion, but is internally converted back to char.
*/
 ...
 * If Return value = 0 the in indicates 'str1' is equal 'str2'.
*/
 ...
 * but the function performs a byte per byte search using the unsigned char 
 ...
 * if the character does not occurin the given memory area.
*/
...
/**
 * @brief Function returns a pointer to a new string which is a duplicate of the string 's'.
...
/**
 * @brief Applies the function 'f' on each character of the string passed as argument,
...
/**
 * @brief Allocates (with malloc(3)) and returns a string representing the integer received
...
/**
 * @brief Allocates (with malloc(3)) and returns an array of strings obtained by splitting 's'
 * using the character 'c' as a delimiter the array mus end with a NULL pointer.
 * @param s The string to be split.
 * @param c The delimiter character.
 * @return The array of new string resulting from the split. NULL if the allocation fails.
*/
 ...
 * @return char* If little is an empety string, big is returned.
